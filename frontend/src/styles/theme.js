export const THEME = {
  ...
  input:
    'w-full p-2 rounded bg-zinc-900 border border-zinc-700 text-white focus:border-emerald-400 focus:ring-2 focus:ring-emerald-500/35 focus:outline-none transition-all placeholder-zinc-500',
  label:
  ...
  button: {
    primary:
      'px-4 py-2 rounded font-bold text-white bg-emerald-600 hover:bg-emerald-500 transition-all shadow-lg shadow-emerald-900/30 ring-1 ring-emerald-500/20 active:scale-[0.98] disabled:opacity-50',
    secondary:
